...
# =============================================================================
cat("\n>>> Calculando Estatísticas Descritivas (Tabela 1)...\n")
...
saveWorkbook(wb, file.path("Resultados/Tabelas", "Estatisticas_Descritivas.xlsx"), overwrite = TRUE)
cat("\n[OK] Tabela de Estatísticas salva em 'Resultados/Tabelas/Estatisticas_Descritivas.xlsx'\n")
